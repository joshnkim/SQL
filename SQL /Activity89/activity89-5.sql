...
-- SELECT InvoiceDetails.InvoiceID, Products.ProductName, InvoiceDetails.UnitPrice FROM InvoiceDetails
...
-- SELECT Customers.CustomerName, Invoices.InvoiceID, SUM(InvoiceDetails.LineTotal) AS LineSum FROM Customers
...
-- SELECT Invoices.InvoiceID, Customers.CustomerName, Customers.City, Customers.State, CURDATE() AS Date, Invoices.TotalDue FROM Customers
-- INNER JOIN Invoices ON Customers.CustomerID = Invoices.CUstomerID 
-- WHERE Invoices.InvoiceID = 3;


SELECT Products.ProductNumber, Products.ProductName, InvoiceDetails.LineTotal, InvoiceDetails.OrderQty, InvoiceDetails.UnitPrice FROM Products
